  ...
  a = function() {
      ...
      , function(t, e, r) {
          ...
          var M = {
            ...
            , R = function() {
              ...
              return e.toNode = function() {
                  ...
                  return this.alternate ? t.setAttribute("d", this.alternate) : t.setAttribute("d", M[this.pathName]),
                  t
              }
              ,
              e.toMarkup = function() {
          ...
          for (var mt = "", ct = 0; ct < st.length; ct++) {
              var ut = st.charAt(ct);
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56320 + ct)),
              Z("text", j, "textord", ut, mt),
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56372 + ct)),
              Z("text", j, "textord", ut, mt),
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56424 + ct)),
              Z("text", j, "textord", ut, mt),
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56580 + ct)),
              Z("text", j, "textord", ut, mt),
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56736 + ct)),
              Z("text", j, "textord", ut, mt),
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56788 + ct)),
              Z("text", j, "textord", ut, mt),
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56840 + ct)),
              Z("text", j, "textord", ut, mt),
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56944 + ct)),
              Z("text", j, "textord", ut, mt),
              ct < 26 && (Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56632 + ct)),
              Z("text", j, "textord", ut, mt),
              Z("math", j, Q, ut, mt = String.fromCharCode(55349, 56476 + ct)),
              Z("text", j, "textord", ut, mt))
          }
          ...
          for (var pt = 0; pt < 10; pt++) {
              var dt = pt.toString();
              Z("math", j, Q, dt, mt = String.fromCharCode(55349, 57294 + pt)),
              Z("text", j, "textord", dt, mt),
              Z("math", j, Q, dt, mt = String.fromCharCode(55349, 57314 + pt)),
              Z("text", j, "textord", dt, mt),
              Z("math", j, Q, dt, mt = String.fromCharCode(55349, 57324 + pt)),
              Z("text", j, "textord", dt, mt),
              Z("math", j, Q, dt, mt = String.fromCharCode(55349, 57334 + pt)),
              Z("text", j, "textord", dt, mt)
          }
          for (var ft = 0; ft < "ÇÐÞçþ".length; ft++) {
              var gt = "ÇÐÞçþ".charAt(ft);
              Z("math", j, Q, gt, gt),
              Z("text", j, "textord", gt, gt)
          }
          ...
          var St = kt
            ...
            , Lt = {
              ...
              mathsym: function(t, e, r, a) {
                  return void 0 === a && (a = []),
                  "boldsymbol" === r.font && qt(t, "Main-Bold", e).metrics ? Bt(t, "Main-Bold", e, r, a.concat(["mathbf"])) : "\\" === t || "main" === Y[e][t].font ? Bt(t, "Main-Regular", e, r, a) : Bt(t, "AMS-Regular", e, r, a.concat(["amsrm"]))
              },
              makeSpan: Ot,
              makeSvgSpan: It,
              ...
              makeOrd: function(t, e, r) {
                  var a, n = t.mode, o = t.text, s = ["mord"], l = "math" === n || "text" === n && e.font, h = l ? e.font : e.fontFamily;
                  ...
                  if (h) {
                      ...
                      if ("boldsymbol" === h || "mathnormal" === h) {
                          ...
                          c.contains(Tt, o) ? (d = "Main-Italic",
                          f = ["mathit"]) : l ? (d = Rt[h].fontName,
                          f = [h]) : (d = Et(h, e.fontWeight, e.fontShape),
                          f = [h, e.fontWeight, e.fontShape]);
                      if (qt(o, d, n).metrics)
                          return Bt(o, d, n, e, s.concat(f));
              ...
              tryCombineChars: function(t) {
                  for (var e = 0; e < t.length - 1; e++) {
                      var r = t[e]
                        , a = t[e + 1];
                      r instanceof $ && a instanceof $ && Ct(r, a) && (r.text += a.text,
            ...
            , le = function t(e, r, a, n) {
              ...
              for (var o = 0; o < e.length; o++) {
                  ...
                  if (s)
                      ...
                      var l = r(i, a.node);
                      l && (a.insertAfter ? a.insertAfter(l) : (e.unshift(l),
                      o++)),
                      a.node = i,
          ...
          var ge = function() {
            ...
            , be = function(t, e, r) {
              return !Y[e][t] || !Y[e][t].replace || 55349 === t.charCodeAt(0) || rt.hasOwnProperty(t) && r && (r.fontFamily && "tt" === r.fontFamily.substr(4, 2) || r.font && "tt" === r.font.substr(4, 2)) || (t = Y[e][t].replace),
              new ve.TextNode(t)
          }
            , ye = function(t) {
            ...
            , we = function(t, e) {
              ...
              if ("mathtt" === r)
                  return "monospace";
              var n = t.text;
              return c.contains(["\\imath", "\\jmath"], n) ? null : (Y[a][n] && Y[a][n].replace && (n = Y[a][n].replace),
              G(n, Lt.fontMap[r].fontName, a) ? Lt.fontMap[r].variant : null)
          }
            , ke = function(t, e, r) {
              if (1 === t.length) {
                  var a = ze(t[0], e);
          ...
          var _e = function(t) {
              ...
              var r = function() {
                  ...
                  if (c.contains(["widehat", "widecheck", "widetilde", "utilde"], a)) {
                      ...
                      if (s > 5)
                          ...
                          i = [0, .24, .3, .3, .36, .42][l],
                          o = a + l) : (r = [0, 600, 1033, 2339, 2340][l],
                          n = [0, 260, 286, 306, 312][l],
                          i = [0, .26, .286, .3, .306, .34][l],
                          o = "tilde" + l)
                      }
                      var h = new R(o)
                        , m = new E([h],{
                  ...
                  var u, p, d, f = [], g = Be[a], x = g[0], v = g[1], b = g[2], y = b / 1e3, w = x.length;
                  if (1 === w)
                      u = ["hide-tail"],
                      p = [g[3]];
                  else if (2 === w)
            ...
            , Ie = function(t, e) {
              ...
              if (a.isStretchy)
                  ...
                  p = Lt.svgData.vec[1]) : ((u = L(u = Lt.makeOrd({
                      mode: a.mode,
                      text: a.label
                  }, e, "textord"))).italic = 0,
                  p = u.width),
          ...
          Qt({
              ...
              htmlBuilder: function(t, e) {
                  var r, a = e.style, n = e.havingStyle(a.sup()), o = Lt.wrapFragment(ue(t.body, n, e), e);
                  o.classes.push("x-arrow-pad"),
                  t.below && (n = e.havingStyle(a.sub()),
                  (r = Lt.wrapFragment(ue(t.below, n, e), e)).classes.push("x-arrow-pad"));
                  var i, s = Oe(t, e), l = -e.fontMetrics().axisHeight + .5 * s.height, h = -e.fontMetrics().axisHeight - .5 * s.height - .111;
          ...
          Qt({
              ...
              handler: function(t, e) {
                  for (var r = t.parser, a = Pt(e[0], "ordgroup").body, n = "", o = 0; o < a.length; o++)
          ...
          var Pe = function(t, e, r) {
            ...
            , Xe = function(t, e, r, a, n, o) {
              ...
              s = null;
              var m = "Size1-Regular";
              "\\uparrow" === t ? l = h = "⏐" : "\\Uparrow" === t ? l = h = "‖" : "\\downarrow" === t ? i = l = "⏐" : "\\Downarrow" === t ? i = l = "‖" : "\\updownarrow" === t ? (i = "\\uparrow",
              l = "⏐",
              h = "\\downarrow") : "\\Updownarrow" === t ? (i = "\\Uparrow",
              l = "‖",
              h = "\\Downarrow") : "[" === t || "\\lbrack" === t ? (i = "⎡",
              l = "⎢",
              h = "⎣",
              m = "Size4-Regular") : "]" === t || "\\rbrack" === t ? (i = "⎤",
              l = "⎥",
              h = "⎦",
              m = "Size4-Regular") : "\\lfloor" === t || "⌊" === t ? (l = i = "⎢",
              h = "⎣",
              m = "Size4-Regular") : "\\lceil" === t || "⌈" === t ? (i = "⎡",
              l = h = "⎢",
              m = "Size4-Regular") : "\\rfloor" === t || "⌋" === t ? (l = i = "⎥",
              h = "⎦",
            ...
            , nr = function(t, e) {
              var r, a, n = e.havingBaseSizing(), o = rr("\\surd", t * n.sizeMultiplier, tr, n), i = n.sizeMultiplier, s = Math.max(0, e.minRuleThickness - e.fontMetrics().sqrtRuleThickness), l = 0, h = 0, m = 0;
              return "small" === o.type ? (t < 1 ? i = 1 : t < 1.4 && (i = .7),
              h = (1 + s) / i,
              (r = We("sqrtMain", l = (1 + s + .08) / i, m = 1e3 + 1e3 * s + 80, s, e)).style.minWidth = "0.853em",
              a = .833 / i) : "large" === o.type ? (m = 1080 * Ke[o.size],
              h = (Ke[o.size] + s) / i,
              l = (Ke[o.size] + s + .08) / i,
              (r = We("sqrtSize" + o.size, l, m, s, e)).style.minWidth = "1.02em",
              a = 1 / i) : (l = t + s + .08,
              h = t + s,
              m = Math.floor(1e3 * t + s) + 80,
              (r = We("sqrtTall", l, m, s, e)).style.minWidth = "0.742em",
              a = 1.056),
              r.height = h,
              r.style.height = l + "em",
              {
          ...
          Qt({
              ...
              htmlBuilder: function(t, e) {
                  cr(t);
                  for (var r, a, n = se(t.body, e, !0, ["mopen", "mclose"]), o = 0, i = 0, s = !1, l = 0; l < n.length; l++)
                      n[l].isMiddle ? s = !0 : (o = Math.max(n[l].height, o),
                      i = Math.max(n[l].depth, i));
                  if (o *= e.sizeMultiplier,
                  i *= e.sizeMultiplier,
                  r = "." === t.left ? ce(e, ["mopen"]) : sr(t.left, o, i, e, t.mode, ["mopen"]),
                  n.unshift(r),
                  s)
          ...
          var ur = function(t, e) {
              var r, a, n = Lt.wrapFragment(ue(t.body, e), e), o = t.label.substr(1), i = e.sizeMultiplier, s = 0, l = c.isCharacterBox(t.body);
              if ("sout" === o)
                  ...
                  var h = 0
                    , m = 0;
                  /box/.test(o) ? (m = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness),
                  h = e.fontMetrics().fboxsep + ("colorbox" === o ? 0 : m)) : h = l ? .2 : 0,
                  r = Ce(n, o, h, e),
              ...
              a.depth = n.depth),
              /cancel/.test(o) && !l ? Lt.makeSpan(["mord", "cancel-lap"], [a], e) : Lt.makeSpan(["mord"], [a], e)
          }
            , pr = function(t, e) {
              var r = 0
          ...
          var br = function(t, e) {
              var r, a, n = t.body.length, o = t.hLinesBeforeRow, s = 0, l = new Array(n), h = [], m = Math.max(e.fontMetrics().arrayRuleWidth, e.minRuleThickness), u = 1 / e.fontMetrics().ptPerEm, p = 5 * u;
              ...
              var q, B, C = b / 2 + e.fontMetrics().axisHeight, N = t.cols || [], O = [];
              for (a = 0,
              B = 0; a < s || B < N.length; ++a,
              ++B) {
                  for (var I = N[B] || {}, $ = !0; "separator" === I.type; ) {
                      if ($ || ((q = Lt.makeSpan(["arraycolsep"], [])).style.width = e.fontMetrics().doubleRuleSep + "em",
                      O.push(q)),
                  ...
                  if (!(a >= s)) {
                      var D = void 0;
                      (a > 0 || t.hskipBeforeAndAfter) && 0 !== (D = c.deflt(I.pregap, p)) && ((q = Lt.makeSpan(["arraycolsep"], [])).style.width = D + "em",
                      O.push(q));
                      var L = [];
                      for (r = 0; r < n; ++r) {
                          var P = l[r]
                      ...
                      O.push(L),
                      (a < s - 1 || t.hskipBeforeAndAfter) && 0 !== (D = c.deflt(I.postgap, p)) && ((q = Lt.makeSpan(["arraycolsep"], [])).style.width = D + "em",
                      O.push(q))
                  }
              }
              if (l = Lt.makeSpan(["mtable"], O),
              h.length > 0) {
            ...
            , wr = function(t, e) {
              ...
              if (t.cols) {
                  ...
                  m -= 1);
                  for (var c = h; c < m; c++)
                      "align" === i[c].type ? (o += yr[i[c].align],
                      l && (s += "none "),
                      l = !0) : "separator" === i[c].type && l && (s += "|" === i[c].separator ? "solid " : "dashed ",
                      l = !1);
          ...
          Qt({
              ...
              handler: function(t, e) {
                  ...
                  if ("\\begin" === a) {
                      ...
                      if (f.name !== o)
                          throw new i("Mismatch: \\begin{" + o + "} matched by \\end{" + f.name + "}",d);
                      return p
                  }
                  return {
                      type: "environment",
          ...
          var Cr = function(t, e) {
            ...
            , Nr = function(t, e) {
              var r, a = Cr(t.size, e.style), n = a.fracNum(), o = a.fracDen();
              r = e.havingStyle(n);
              ...
              if (t.hasBarLine ? (t.barSize ? (m = At(t.barSize, e),
              h = Lt.makeLineSpan("frac-line", e, m)) : h = Lt.makeLineSpan("frac-line", e),
              m = h.height,
              c = h.height) : (h = null,
              m = 0,
              ...
              h) {
                  ...
                  u - i.depth - (y + .5 * m) < p && (u += p - (u - i.depth - (y + .5 * m))),
              ...
              x = null == t.leftDelim ? ce(e, ["mopen"]) : ir(t.leftDelim, g, !0, e.havingStyle(a), t.mode, ["mopen"]),
              v = t.continued ? Lt.makeSpan([]) : null == t.rightDelim ? ce(e, ["mclose"]) : ir(t.rightDelim, g, !0, e.havingStyle(a), t.mode, ["mclose"]),
          ...
          Qt({
              ...
              handler: function(t, e) {
                  var r, a = t.parser, n = t.funcName, o = e[0], i = e[1], s = null, l = null, h = "auto";
                  switch (n) {
                  case "\\cfrac":
                  case "\\dfrac":
                  case "\\frac":
          ...
          Qt({
              ...
              handler: function(t, e) {
                  ...
                  var i = o ? $r(o.text) : null
                    , s = Ht(e[1], "atom");
                  s && (s = Ft(e[1], "close"));
                  var l, h = s ? $r(s.text) : null, m = Pt(e[2], "size"), c = null;
          ...
          var Er = function(t, e) {
              var r, a, n = e.style, o = Ht(t, "supsub");
              o ? (r = o.sup ? ue(o.sup, e.havingStyle(n.sup()), e) : ue(o.sub, e.havingStyle(n.sub()), e),
              a = Pt(o.base, "horizBrace")) : a = Pt(t, "horizBrace");
              var i, s = ue(a.base, e.havingBaseStyle(w.DISPLAY)), l = Oe(a, e);
          ...
          Qt({
              ...
              htmlBuilder: function(t, e) {
                  var r = At(t.height, e)
                    , a = 0;
                  t.totalheight.number > 0 && (a = At(t.totalheight, e) - r,
              ...
              mathmlBuilder: function(t, e) {
                  ...
                  var a = At(t.height, e)
                    , n = 0;
                  if (t.totalheight.number > 0 && (n = (n = At(t.totalheight, e) - a).toFixed(2),
          ...
          Qt({
              ...
              htmlBuilder: function(t, e) {
                  var r;
                  "clap" === t.alignment ? (r = Lt.makeSpan([], [ue(t.body, e)]),
                  r = Lt.makeSpan(["inner"], [r], e)) : r = Lt.makeSpan(["inner"], [ue(t.body, e)]);
          ...
          var Lr = function(t, e, r, a, n, o, i) {
            ...
            , Pr = ["\\smallint"]
            , Hr = function(t, e) {
              var r, a, n, o = !1, i = Ht(t, "supsub");
              i ? (r = i.sup,
              a = i.sub,
              n = Pt(i.base, "op"),
              o = !0) : n = Pt(t, "op");
              var s, l = e.style, h = !1;
              if (l.size === w.DISPLAY.size && n.symbol && !c.contains(Pr, n.name) && (h = !0),
              n.symbol) {
                  var m = h ? "Size2-Regular" : "Size1-Regular"
                    , u = "";
                  if ("\\oiint" !== n.name && "\\oiiint" !== n.name || (u = n.name.substr(1),
                  n.name = "oiint" === u ? "\\iint" : "\\iiint"),
                  s = Lt.makeSymbol(n.name, m, "math", e, ["mop", "op-symbol", h ? "large-op" : "small-op"]),
                  u.length > 0) {
                      var p = s.italic
              ...
              var v = 0
                , b = 0;
              return (s instanceof $ || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (v = (s.height - s.depth) / 2 - e.fontMetrics().axisHeight,
              b = s.italic),
              o ? Lr(s, r, a, e, l, b, v) : (v && (s.style.position = "relative",
              s.style.top = v + "em"),
              s)
          }
            , Fr = function(t, e) {
              ...
              if (t.symbol)
                  ...
                  c.contains(Pr, t.name) && r.setAttribute("largeop", "false");
              else if (t.body)
          ...
          var Ur = function(t, e) {
              var r, a, n, o, i = !1, s = Ht(t, "supsub");
              if (s ? (r = s.sup,
              a = s.sub,
              n = Pt(s.base, "operatorname"),
              i = !0) : n = Pt(t, "operatorname"),
              n.body.length > 0) {
          ...
          te({
              ...
              htmlBuilder: function(t, e) {
                  ...
                  if (r)
                      return r(t, e);
                  var a, n, o, i = t.base, s = t.sup, l = t.sub, h = ue(i, e), m = e.fontMetrics(), u = 0, p = 0, d = i && c.isCharacterBox(i);
                  if (s) {
          ...
          ca("\\aa", "\\r a"),
          ca("\\AA", "\\r A"),
          ca("\\textcopyright", "\\html@mathml{\\textcircled{c}}{\\char`©}"),
          ca("\\copyright", "\\TextOrMath{\\textcopyright}{\\text{\\textcopyright}}"),
          ca("\\textregistered", "\\html@mathml{\\textcircled{\\scriptsize R}}{\\char`®}"),
          ca("ℬ", "\\mathscr{B}"),
          ca("ℰ", "\\mathscr{E}"),
          ca("ℱ", "\\mathscr{F}"),
          ca("ℋ", "\\mathscr{H}"),
          ...
          ca("∉", "\\notin"),
          ca("≘", "\\html@mathml{\\mathrel{=\\kern{-1em}\\raisebox{0.4em}{$\\scriptsize\\frown$}}}{\\mathrel{\\char`≘}}"),
          ca("≙", "\\html@mathml{\\stackrel{\\tiny\\wedge}{=}}{\\mathrel{\\char`≘}}"),
          ca("≚", "\\html@mathml{\\stackrel{\\tiny\\vee}{=}}{\\mathrel{\\char`≚}}"),
          ca("≛", "\\html@mathml{\\stackrel{\\scriptsize\\star}{=}}{\\mathrel{\\char`≛}}"),
          ca("≝", "\\html@mathml{\\stackrel{\\tiny\\mathrm{def}}{=}}{\\mathrel{\\char`≝}}"),
          ca("≞", "\\html@mathml{\\stackrel{\\tiny\\mathrm{m}}{=}}{\\mathrel{\\char`≞}}"),
          ca("≟", "\\html@mathml{\\stackrel{\\tiny?}{=}}{\\mathrel{\\char`≟}}"),
          ca("⟂", "\\perp"),
          ...
          ca("\\dots", (function(t) {
              ...
              return r in fa ? e = fa[r] : ("\\not" === r.substr(0, 4) || r in Y.math && c.contains(["bin", "rel"], Y.math[r].group)) && (e = "\\dotsb"),
              e
          }
          ));
          var ga = {
          ...
          ca("\\bmod", "\\mathchoice{\\mskip1mu}{\\mskip1mu}{\\mskip5mu}{\\mskip5mu}\\mathbin{\\rm mod}\\mathchoice{\\mskip1mu}{\\mskip1mu}{\\mskip5mu}{\\mskip5mu}"),
          ca("\\pod", "\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern8mu}{\\mkern8mu}{\\mkern8mu}(#1)"),
          ca("\\pmod", "\\pod{{\\rm mod}\\mkern6mu#1}"),
          ca("\\mod", "\\allowbreak\\mathchoice{\\mkern18mu}{\\mkern12mu}{\\mkern12mu}{\\mkern12mu}{\\rm mod}\\,\\,#1"),
          ca("\\pmb", "\\html@mathml{\\@binrel{#1}{\\mathrlap{#1}\\kern0.5px#1}}{\\mathbf{#1}}"),
          ca("\\\\", "\\newline"),
          ca("\\TeX", "\\textrm{\\html@mathml{T\\kern-.1667em\\raisebox{-.5ex}{E}\\kern-.125emX}{TeX}}");
          var xa = P["Main-Regular"]["T".charCodeAt(0)][1] - .7 * P["Main-Regular"]["A".charCodeAt(0)][1] + "em";
          ca("\\LaTeX", "\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{" + xa + "}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}"),
          ca("\\KaTeX", "\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{" + xa + "}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}"),
          ...
          ca("\\dblcolon", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-.9mu}\\vcentcolon}}{\\mathop{\\char"2237}}'),
          ca("\\coloneqq", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}=}}{\\mathop{\\char"2254}}'),
          ca("\\Coloneqq", '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}=}}{\\mathop{\\char"2237\\char"3d}}'),
          ca("\\coloneq", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}}}{\\mathop{\\char"3a\\char"2212}}'),
          ca("\\Coloneq", '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}}}{\\mathop{\\char"2237\\char"2212}}'),
          ca("\\eqqcolon", '\\html@mathml{\\mathrel{=\\mathrel{\\mkern-1.2mu}\\vcentcolon}}{\\mathop{\\char"2255}}'),
          ca("\\Eqqcolon", '\\html@mathml{\\mathrel{=\\mathrel{\\mkern-1.2mu}\\dblcolon}}{\\mathop{\\char"3d\\char"2237}}'),
          ca("\\eqcolon", '\\html@mathml{\\mathrel{\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\vcentcolon}}{\\mathop{\\char"2239}}'),
          ca("\\Eqcolon", '\\html@mathml{\\mathrel{\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\dblcolon}}{\\mathop{\\char"2212\\char"2237}}'),
          ca("\\colonapprox", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\approx}}{\\mathop{\\char"3a\\char"2248}}'),
          ca("\\Colonapprox", '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\approx}}{\\mathop{\\char"2237\\char"2248}}'),
          ca("\\colonsim", '\\html@mathml{\\mathrel{\\vcentcolon\\mathrel{\\mkern-1.2mu}\\sim}}{\\mathop{\\char"3a\\char"223c}}'),
          ca("\\Colonsim", '\\html@mathml{\\mathrel{\\dblcolon\\mathrel{\\mkern-1.2mu}\\sim}}{\\mathop{\\char"2237\\char"223c}}'),
          ca("∷", "\\dblcolon"),
          ca("∹", "\\eqcolon"),
          ca("≔", "\\coloneqq"),
          ca("≕", "\\eqqcolon"),
          ...
          ca("\\simcolon", "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}"),
          ca("\\simcoloncolon", "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\dblcolon}"),
          ca("\\approxcolon", "\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\vcentcolon}"),
          ca("\\approxcoloncolon", "\\mathrel{\\approx\\mathrel{\\mkern-1.2mu}\\dblcolon}"),
          ca("\\notni", "\\html@mathml{\\not\\ni}{\\mathrel{\\char`∌}}"),
          ...
          ca("\\llbracket", "\\html@mathml{\\mathopen{[\\mkern-3.2mu[}}{\\mathopen{\\char`⟦}}"),
          ca("\\rrbracket", "\\html@mathml{\\mathclose{]\\mkern-3.2mu]}}{\\mathclose{\\char`⟧}}"),
          ca("⟦", "\\llbracket"),
          ca("⟧", "\\rrbracket"),
          ca("\\lBrace", "\\html@mathml{\\mathopen{\\{\\mkern-3.2mu[}}{\\mathopen{\\char`⦃}}"),
          ca("\\rBrace", "\\html@mathml{\\mathclose{]\\mkern-3.2mu\\}}}{\\mathclose{\\char`⦄}}"),
          ca("⦃", "\\lBrace"),
          ca("⦄", "\\rBrace"),
          ca("\\darr", "\\downarrow"),
          ca("\\dArr", "\\Downarrow"),
          ...
          var va = {
                  ...
                  if ("string" == typeof r) {
                      ...
                      if (-1 !== r.indexOf("#"))
                          for (var n = r.replace(/##/g, ""); -1 !== n.indexOf("#" + (a + 1)); )
                              ++a;
                      for (var o = new sa(r,this.settings), i = [], s = o.lex(); "EOF" !== s.text; )
                          i.push(s),
                          s = o.lex();
                      return i.reverse(),
                      {
            ...
            , ka = function() {
              ...
              return e.expect = function(t, e) {
                  if (void 0 === e && (e = !0),
                  this.fetch().text !== t)
                      throw new i("Expected '" + t + "', got '" + this.fetch().text + "'",this.fetch());
                  e && this.consume()
              }
              ,
              e.consume = function() {
              ...
              e.parseExpression = function(e, r) {
                  for (var a = []; ; ) {
                      ...
                      if (r && n.text === r)
                          break;
                      if (e && na[n.text] && na[n.text].infix)
                          break;
              ...
              e.handleInfixNodes = function(t) {
                  ...
                  if (-1 !== r && e) {
                      var o, s, l = t.slice(0, r), h = t.slice(r + 1);
                  ...
                  for (; ; ) {
                      ...
                      if ("\\limits" === n.text || "\\nolimits" === n.text) {
                          ...
                          if (o) {
                              ...
                              if (!(o = Ht(a, "operatorname")) || !o.alwaysHandleSupSub)
              ...
              e.parseRegexGroup = function(t, e) {
                  var r = this.mode;
                  this.mode = "text";
                  for (var a, n = this.fetch(), o = n, s = ""; "EOF" !== (a = this.fetch()).text && t.test(s + a.text); )
                      s += (o = a).text,
                      this.consume();
                  if ("" === s)
              ...
              e.parseSymbol = function() {
                  ...
                  wa.hasOwnProperty(e[0]) && !Y[this.mode][e[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + e[0] + '" used in math mode', t),
                  e = wa[e[0]] + e.substr(1));
                  var o, s = ia.exec(e);
                  ...
                  Y[this.mode][e]) {
                      ...
                      var l, h = Y[this.mode][e].group, m = a.range(t);
                  ...
                  s)
                      for (var u = 0; u < s[0].length; u++) {
                          ...
                          if (!d)
                              throw new i("Accent " + p + " unsupported in " + this.mode + " mode",t);
                          o = {
                              type: "accent",
                              mode: this.mode,
                              loc: a.range(t),
...
, function(t, e, r) {
  ...
  var o = function(t, e) {
      for (var r = "", a = t[t.length - 1].loc.start, n = t.length - 1; n >= 0; n--)
          t[n].loc.start > a && (r += " ",
          a = t[n].loc.start),
          r += t[n].text,
          a += t[n].text.length;
    ...
    , i = {
                  ...
                  if (c) {
                      for (var u = h[m].task, p = 0; p < u.action_.length; p++) {
                          ...
                          if (l.actions[u.action_[p].type_])
                              d = l.actions[u.action_[p].type_](n, c.match_, u.action_[p].option);
                          else {
                              if (!i.actions[u.action_[p].type_])
                                  throw ["MhchemBugA", "mhchem bug A. Please report. (" + u.action_[p].type_ + ")"];
      ...
      patterns: {
          ...
          match_: function(t, e) {
              ...
              if ("function" == typeof r)
                  return i.patterns.patterns[t](e);
              var a = e.match(r);
              return a ? {
      ...
      actions: {
          ...
          "{text}": function(t, e) {
              var r = ["{"];
              return i.concatArray(r, i.go(e, "text")),
              r.push("}"),
              r
          },
          ...
          "1/2": function(t, e) {
              var r = [];
              e.match(/^[+\-]/) && (r.push(e.substr(0, 1)),
              e = e.substr(1));
              var a = e.match(/^([0-9]+|\$[a-z]\$|[a-z])\/([0-9]+)(\$[a-z]\$|[a-z])?$/);
              return a[1] = a[1].replace(/\$/g, ""),
              r.push({
                  type_: "frac",
                  p1: a[1],
                  p2: a[2]
              }),
              a[3] && (a[3] = a[3].replace(/\$/g, ""),
              r.push({
                  type_: "tex-math",
                  p1: a[3]
              })),
      ...
      createTransitions: function(t) {
          ...
          for (e in t)
              for (r in t[e])
                  for (a = t[e][r].stateArray || [],
                  n = 0; n < a.length; n++) {
                      var i = t[e][r];
                      if (i.action_) {
                          i.action_ = [].concat(i.action_);
                          for (var s = 0; s < i.action_.length; s++)
                              "string" == typeof i.action_[s] && (i.action_[s] = {
                                  type_: i.action_[s]
                              })
                      } else
                          i.action_ = [];
      ...
      ce: {
          ...
          actions: {
              ...
              "charge or bond": function(t, e) {
                  if (t.beginsWithBond) {
                      var r = [];
                      return i.concatArray(r, this.output(t)),
              ...
              "- after o/d": function(t, e, r) {
                  ...
                  var h = [];
                  return l ? (i.concatArray(h, this.output(t)),
                  h.push({
                      type_: "hyphen"
                  })) : (a = i.patterns.match_("digits", t.d || ""),
                  r && a && "" === a.remainder ? (i.concatArray(h, i.actions["d="](t, e)),
                  i.concatArray(h, this.output(t))) : (i.concatArray(h, this.output(t)),
              ...
              output: function(t, e, r) {
                  ...
                  o = "M" === t.rqt ? i.go(t.rq, "tex-math") : "T" === t.rqt ? [{
                      type_: "text",
                      p1: t.rq || ""
                  }] : i.go(t.rq),
                  a = {
                  ...
                  (t.a || t.b || t.p || t.o || t.q || t.d || r) && (t.sb && a.push({
                      type_: "entitySkip"
                  }),
                  t.o || t.q || t.d || t.b || t.p || 2 === r ? t.o || t.q || t.d || !t.b && !t.p ? t.o && "kv" === t.dType && i.patterns.match_("d-oxidation$", t.d || "") ? t.dType = "oxidation" : t.o && "kv" === t.dType && !t.q && (t.dType = void 0) : (t.o = t.a,
                  t.d = t.b,
                  t.q = t.p,
              ...
              "oxidation-output": function(t, e) {
                  var r = ["{"];
                  return i.concatArray(r, i.go(e, "oxidation")),
                  r.push("}"),
                  r
              },
      ...
      pu: {
          ...
          actions: {
              enumber: function(t, e) {
                  ...
                  e[1] && (i.concatArray(r, i.go(e[1], "pu-9,9")),
                  e[2] && (e[2].match(/[,.]/) ? i.concatArray(r, i.go(e[2], "pu-9,9")) : r.push(e[2])),
                  e[3] = e[4] || e[3],
                  e[3] && (e[3] = e[3].trim(),
                  "e" === e[3] || "*" === e[3].substr(0, 1) ? r.push({
                      type_: "cdot"
                  }) : r.push({
                      type_: "times"
                  }))),
              ...
              output: function(t) {
                  ...
                  t.q) {
                      ...
                      n.d.length > 1 || n.q.length > 1 ? e.push({
                          type_: " / "
                      }) : e.push({
                          type_: "/"
                      }),
  ...
  var s = {
      go: function(t, e) {
          ...
          for (var r = "", a = !1, n = 0; n < t.length; n++) {
              var o = t[n];
              "string" == typeof o ? r += o : (r += s._go2(o),
              "1st-level escape" === o.type_ && (a = !0))
          }
          return e || a || !r || (r = "{" + r + "}"),
          r
      },
      ...
      _go2: function(t) {
          ...
          case "chemfive":
              ...
              r.a && (r.a.match(/^[+\-]/) && (r.a = "{" + r.a + "}"),
              e += r.a + "\\,"),
              (r.b || r.p) && (e += "{\\vphantom{X}}",
              e += "^{\\hphantom{" + (r.b || "") + "}}_{\\hphantom{" + (r.p || "") + "}}",
              e += "{\\vphantom{X}}",
              e += "^{\\smash[t]{\\vphantom{2}}\\mathllap{" + (r.b || "") + "}}",
              e += "_{\\vphantom{2}\\mathllap{\\smash[t]{" + (r.p || "") + "}}}"),
              r.o && (r.o.match(/^[+\-]/) && (r.o = "{" + r.o + "}"),
              e += r.o),
              "kv" === t.dType ? ((r.d || r.q) && (e += "{\\vphantom{X}}"),
              r.d && (e += "^{" + r.d + "}"),
              r.q && (e += "_{\\smash[t]{" + r.q + "}}")) : "oxidation" === t.dType ? (r.d && (e += "{\\vphantom{X}}",
              e += "^{" + r.d + "}"),
              r.q && (e += "{\\vphantom{X}}",
              e += "_{\\smash[t]{" + r.q + "}}")) : (r.q && (e += "{\\vphantom{X}}",
              e += "_{\\smash[t]{" + r.q + "}}"),
              r.d && (e += "{\\vphantom{X}}",
              e += "^{" + r.d + "}"));
              break;
  ...
  $docsify.plugins = [].concat((function(t) {
      t.beforeEach(t=>{
          ...
          )).replace(/\$`\$/g, "c194a9ed").replace(/\\`\{/g, "c194a9ee").replace(/\\\$/g, "c194a9eb").replace(/(`{1,})([\s\S]*?)\1/g, (function(t) {
              return t.replace(/\$/g, "c194a9ef")
          }
          )).replace(c, "`");
          return e = e.replace(u, "$ `$").replace(p, "\\`{"),
          e = e.replace(/(\$\$)([\s\S]*?)(\$\$)/g, (function(t, e, r) {
